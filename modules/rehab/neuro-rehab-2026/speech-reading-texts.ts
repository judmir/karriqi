...
export const SPEECH_BASELINE_B = {
  title: "Baseline B — articulation",
  hint: "Practice rr, r, ll, l, th, dh, gj, q, ç, xh, sh, zh.",
...
export const SPEECH_BASELINE_C = {
  title: "Baseline C — expressive prosody",
  hint: "Natural rhythm, melody, and expressive speech.",
...
/** Thu, Sun — English baseline (2×/week). */
export const SPEECH_ENGLISH_WEEKDAYS = [0, 4] as const;
